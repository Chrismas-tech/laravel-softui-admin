        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'admin.youtube-videos.index' ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-button-play {{ Route::currentRouteName() === 'admin.youtube-videos.index' ? 'text-white' : 'text-dark' }}" width="12px" height="12px"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'admin.album-photos.index' ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-images {{ Route::currentRouteName() === 'admin.album-photos.index' ? 'text-white' : 'text-dark' }}" width="12px" height="12px"></i>
                    </div>
